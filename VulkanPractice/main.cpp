...
private:
    ...
    void generateMipmaps(VkImage targetImage, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
    ...
    void loadModel() {
        ...
        for (const auto& shape : shapes) {
            for (const auto& index : shape.mesh.indices) {
                ...
                vertex_indices.push_back(uniqueVertices[vertex]);
            }
        }
    }
